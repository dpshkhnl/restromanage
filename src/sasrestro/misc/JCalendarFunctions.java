...
public class JCalendarFunctions implements Serializable {
	...
	public static void main(String[] args) {
		...
		System.out.println(jcalfunction.addMonthToEngDate("2014-02-01", "plus", 5));
	}
...
System.out.println("Formatted date "+dt.format(frmtdDate));
	...
	public String generateValidNepDate(int yearadd, String nepIssDtString){
		...
		if(Integer.valueOf(day)==1){
			...
			if(month<10){
				mnth="0"+month;
			}else{mnth=String.valueOf(month);}
			int days=Integer.valueOf(day)-1;
			if(days<10){day="0"+days;}else{day=String.valueOf(days);}
